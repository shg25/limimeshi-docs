...
- **002-campaign-listとの一貫性**: 002でも同じパターンを使用
...
- **002-campaign-listとの一貫性**: 002でも同じパターンで読み取り
...
- **パフォーマンス**: リアルタイムカウントではなく、集約データとして管理することで、002-campaign-listでの表示が高速化
...
### Rationale
- **002-campaign-listとの一貫性**: 002でもJetpack Compose + Material 3を使用
