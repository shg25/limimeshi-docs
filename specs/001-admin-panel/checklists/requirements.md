...
2. **メニューの管理** (P1): 登録・編集・削除・検索、ステータス自動判定
...
- **ステータス**: 販売開始/終了日時から自動判定（予定/発売から◯日経過/発売から◯ヶ月以上経過/販売終了）。手動設定なし
...
- 002-menu-list との整合性確保のため、ステータス表示ロジックを更新（「販売中」削除、「予定/発売から◯日経過/発売から◯ヶ月以上経過/販売終了」に統一）
